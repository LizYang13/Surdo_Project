...
{	
    ...
    NSLocale *local =[[NSLocale alloc] initWithLocaleIdentifier:LanguageCode];
    speechRecognizer = [[SFSpeechRecognizer alloc] initWithLocale:local];
    UnitySendMessage("HoloKitCamera", "onMessage", "Setting Success");
}
// recording
- (void)startRecording {
        ...
        recognitionTask =[speechRecognizer recognitionTaskWithRequest:recognitionRequest resultHandler:^(SFSpeechRecognitionResult * _Nullable result, NSError * _Nullable error)
                          {
                              if (result != nil) {
                                  ...
                                  UnitySendMessage("HoloKitCamera", "onResults", [transcriptText UTF8String]);
                                  ...
                                  UnitySendMessage("HoloKitCamera", "onResults", "nil");
